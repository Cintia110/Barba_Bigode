...
<html>
    ...
    <body>
        ...
        <form name="formFilial" action="" method="post">
            <div id="body">
                ...
                <li>Localização</li>
                    <li><input type="text" name="txtLocalizacao" placeholder="Localização da filial" class="input"/>
                    </li>
                <li>Responsável</li>
                    <li><input type="text" name="txtResponsavel" placeholder="Responsável pela Filial" class="input"/>
                    </li>
